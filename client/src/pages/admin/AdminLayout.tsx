...
export default function AdminLayout() {
    ...
    const AdminLinkData = [
        ...
        { to: "/admin/products/new", label: "Agregar Producto", icon: PlusIcon },
        { to: "/admin/products", label: "Productos", icon: PackageSearchIcon },
        { to: "/admin/orders", label: "Pedidos", icon: ShoppingBagIcon },
        { to: "/admin/delivery-partners", label: "Socio Repartidor", icon: Truck },
