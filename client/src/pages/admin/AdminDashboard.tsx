...
export default function AdminDashboard() {
    ...
    const cards = stats
        ? [
            ...
            { label: "Total de Usuarios", value: stats.totalUsers, icon: UsersIcon },
            { label: "Total de Productos", value: stats.totalProducts, icon: PackageIcon },
            { label: "Sin Stock", value: stats.outOfStock, icon: AlertTriangleIcon },
        ]
        : [];
        ...
        <div className="space-y-6">
            ...
            <div className="bg-white rounded-2xl border border-app-border overflow-hidden">
                <div className="px-6 py-5 border-b border-app-border flex items-center justify-between">
                    <h2 className="text-lg font-semibold text-zinc-900">Pedidos Recientes</h2>
                ...
                <div className="overflow-x-auto">
                    <table className="w-full text-left text-sm whitespace-nowrap">
                        <thead className="bg-app-cream/50 text-zinc-500 uppercase text-xs font-semibold">
                            <tr>
                                <th className="px-6 py-3">ID de Pedido</th>
