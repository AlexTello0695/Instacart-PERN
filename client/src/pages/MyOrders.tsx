...
const MyOrders = () => {
  ...
  const tabs = ["Todos", "Realizado", "En ruta", "Entregado"]
  ...
  return (
    <div className="min-h-screen bg-app-cream mb-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <h1 className="text-2xl font-semibold text-app-green mb-6">Mis Pedidos</h1>
        ...
        {loading ? (
          ...
          <div className="text-center py-16">
            ...
            <h2 className="text-lg font-medium text-app-green mb-2">Aún sin pedidos</h2>
            <p className="text-sm text-app-text-light mb-4">Empieza a comprar para ver tus pedidos aquí</p>
            <Link
              to={"/products"}
          ...
          <div className="space-y-4">
            {orders.map((order) => (
              ...
              <div className="flex items-start justify-between mb-3">
                {/* {Izquierda} */}
                <div>
                  <p className="text-sm font-medium text-app-green">Pedido #{order._id.slice(-8).toUpperCase()}</p>
