        ...
        <div className="min-h-screen bg-app-cream">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
                ...
                <nav className="flex items-center gap-2 text-sm text-app-text-light mb-6">
                    ...
                    <span>/</span>
                    <span className="text-app-green font-medium">{activeCategory ? activeCategory.name : "Todos los productos"}</span>
                </nav>
                    ...
                    <main className="flex-1">
                        ...
                        <div className="flex items-center justify-between mb-6">
                            <div>
                                ...
                                <p className="text-sm text-app-text-light mt-0.5">{products.length} productos encontrados</p>
                            </div>

                            <div className="flex flex-col lg:items-center gap-3">
                                {/* {Alternar filtro para móviles} */}
                                <button
                        ...
                        {loading ? (
                            ...
                            <div className="text-center py-16">
                                <p className="text-lg font-semibold text-app-green mb-2">No se encontraron productos</p>
                                <p className="text-sm text-app-text-light mb-4">Ajusta los términos de búsqueda e inténtalo de nuevo</p>
                                <button
