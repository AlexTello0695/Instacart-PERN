        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 w-full">
            <div className="max-w-xl xl:pl-10">
                ...
                <div className="flex flex-wrap gap-3">
                    <Link to="/products" className="px-7 py-3 bg-orange-400 text-white font-semibold rounded-full hover:bg-amber-500 transition-all flex-center gap-2 active:scale-[0.98]">
                        Compra Ahora <ArrowRightIcon />
                    </Link>
                    <Link to="/products" className="px-7 py-3 bg-white/10 text-white font-semibold rounded-full hover:bg-white/20 transition-all border border-white/20 flex-center gap-2">
                        Explorar Categorías <ArrowRightIcon />
                    </Link>
                </div>
            </div>
        </div>
