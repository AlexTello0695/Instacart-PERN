    ...
    return (
        <div className="bg-white rounded-2xl p-6 animate-fade-in">
            <h2 className="text-lg font-semibold text-app-green mb-5 flex items-center gap-2">
                <CreditCardIcon className="size-5" /> Método de Pago
            </h2>
            <div className="space-y-3">
                {[
                    { value: "card", label: "Tarjeta de Crédito / Débito", desc: "Paga de forma segura con tu tarjeta" },
                    { value: "cash", label: "Efectivo al Entregar", desc: "Paga cuando recibas tu pedido" },
                ].map((method) => (
