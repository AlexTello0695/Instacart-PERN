...
export default function OrderOTP({ order }: { order: any }) {
    const showOtp = order.deliveryOtp && ["Asignado", "Empacado", "En ruta"].includes(order.status);
    ...
    return (
        <div className="bg-linear-to-r from-app-green to-app-green-light rounded-2xl p-6 text-white">
            <div className="flex items-center gap-3 mb-3">
                ...
                <div>
                    <h3 className="font-semibold">Código de Entrega OTP</h3>
                    <p className="text-xs text-white/70">Comparte este código con tu socio repartidor</p>
                </div>
            </div>
